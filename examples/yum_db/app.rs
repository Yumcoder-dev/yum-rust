...
fn main() {
    ...
    let mut store = YumDB::open(path).expect("unable to open file");
...
impl YumDB {
    ...
    pub fn load(&mut self) -> io::Result<()> {
        ...
        loop {
            ...
            let maybe_kv = YumDB::process_record(&mut f);
    ...
    pub fn get_at(&mut self, position: u64) -> io::Result<KeyValuePair> {
        ...
        let kv = YumDB::process_record(&mut f)?;
